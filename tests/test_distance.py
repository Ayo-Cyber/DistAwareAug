...
class TestDistanceMetrics(unittest.TestCase):
    ...
    def test_filter_diverse_samples(self):
        ...
        diverse_samples_limited = dm.filter_diverse_samples(
            samples, threshold=0.01, max_samples=2
        )
    ...
    def test_filter_diverse_samples_with_reference(self):
        ...
        diverse_samples = dm.filter_diverse_samples(
            candidates, reference=reference, threshold=0.5
        )
    ...
    def test_adaptive_threshold(self):
        ...
        clustered_data = np.array([
            [0, 0], [0.1, 0.1], [0.2, 0.2],  # Tight cluster
            [10, 10], [10.1, 10.1], [10.2, 10.2]  # Another tight cluster
        ])
