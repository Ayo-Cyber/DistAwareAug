...
class StatisticallyGovernedDistribution:
    ...
    def _analyze_feature_distribution(self, feature_data: np.ndarray, feature_idx: int) -> Dict[str, Any]:
        """
    ...
    def _fit_best_distribution(self, data: np.ndarray, feature_type: str) -> Optional[Dict[str, Any]]:
        """
